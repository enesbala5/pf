<script lang="ts">
	...
	const tags: Tag[] = ['branding', 'identity', 'ui-ux', 'smmm', 'tshirt', 'website', 'development'];
...
<div class="mx-auto mt-24 w-full font-aeonik lg:w-10/12">
	...
	<div class="relative mx-auto mt-24 text-xl lg:grid lg:grid-cols-10">
		<div class="mx-4 flex items-center justify-between lg:col-span-10 lg:mx-0 lg:mb-0 2xl:col-span-9 2xl:col-start-2">
			...
			<div class="col-span-6 col-start-5 flex cursor-pointer justify-end lg:cursor-none">
				<div
				...
				>
					...
					<svg
						...
						class="h-5 w-5 transition-transform {filtering ? 'rotate-180' : ''} delay-75"
						fill="none"
						viewBox="0 0 24 24"
						stroke="currentColor"
						stroke-width="2"
		...
		{#if filtering}
			<div
				...
				class=" noScroll col-span-9 col-start-2 mt-4 grid grid-flow-col-dense grid-rows-1 gap-2 overflow-scroll px-4 py-2 text-black dark:text-white lg:mb-0 lg:overflow-hidden lg:px-0 "
			>
				{#each tags as tag}
	...
	<!-- project -->
	<div
		class="relative mx-auto mb-12 mt-12 px-4 first-letter:text-xl lg:mt-12 lg:grid lg:grid-cols-10 lg:gap-2 lg:gap-y-12 lg:px-0"
	>
